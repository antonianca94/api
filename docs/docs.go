    ...
    "paths": {
        "/buyers": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/controllers.Buyer"
                            }
                        }
                    },
                    "500": {
                        "description": "Erro ao buscar compradores",
                        "schema": {
                            "type": "object",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Comprador para criar",
                        "name": "buyer",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Erro ao criar comprador",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/buyers/user/{users_id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Erro ao buscar comprador",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/buyers/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Erro ao deletar comprador",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Dados do comprador para atualizar",
                        "name": "buyer",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Erro ao atualizar comprador",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
